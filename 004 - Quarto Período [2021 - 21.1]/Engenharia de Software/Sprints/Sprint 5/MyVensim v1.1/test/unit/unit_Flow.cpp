...
void unit_Flow_setSource( void)
{
    ...
    Flow * f1 = new FlowTestUnit();
    System *s1 = new SystemImpl("System 1", 100);
    f1->setSource(s1);
...
void unit_Flow_connect( void)
{
    ...
    Flow * f1 = new FlowTestUnit();
    System *s1 = new SystemImpl("System 1", 100);
    System *s2 = new SystemImpl("System 2", 0);
    f1->connect(s1, s2);
    assert(f1->getSource() == s1);
...
void unit_Flow_assignmentOperator(void)
{
    ...
    Flow * f1 = new FlowTestUnit("Flow 1 [Original]");
    Flow *f2 = new FlowTestUnit();
    f2 = f1;

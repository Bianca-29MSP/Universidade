...
void complexFuncionalTest()
{
    ...
    FlowComplexF *f = new FlowComplexF("f");//f
    FlowComplexG *g = new FlowComplexG("g");//g
    FlowComplexT *t = new FlowComplexT("t");//t
    FlowComplexR *r = new FlowComplexR("r");//r
    FlowComplexU *u = new FlowComplexU("u");//u
    FlowComplexV *v = new FlowComplexV("v");//v

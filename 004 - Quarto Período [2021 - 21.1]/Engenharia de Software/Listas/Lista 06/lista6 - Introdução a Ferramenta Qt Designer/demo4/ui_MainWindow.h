...
public:
    ...
    {
    MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Minha Calculadora", 0));
    ...
    actionSai_r->setText(QApplication::translate("MainWindow", "Sai&r", 0));
    action_Copia->setText(QApplication::translate("MainWindow", "&Copia", 0));
    label_2->setText(QApplication::translate("MainWindow", "Parcela 1:", 0));
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; font-size:8pt;\">0</p></body></html>", 0));
    label_3->setText(QApplication::translate("MainWindow", "Parcela 2:", 0));
...
"</style></head><body style=\" font-family:'MS Shell Dlg 2'; font-size:8.25pt; font-weight:400; font-style:normal;\">\n"
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; font-size:8pt;\">0</p></body></html>", 0));
    label_4->setText(QApplication::translate("MainWindow", "Resultado:", 0));
    exitButton->setText(QApplication::translate("MainWindow", "Sair", 0));
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:18pt; font-weight:600;\">C A L C U L A D O R A</span></p></body></html>", 0));
    execButton->setText(QApplication::translate("MainWindow", "Executar", 0));
    groupBox->setTitle(QApplication::translate("MainWindow", "Opera\303\247\303\265es", 0));
    radioButtonMult->setText(QApplication::translate("MainWindow", "Multipilica\303\247\303\243o", 0));
    radioButtonSoma->setText(QApplication::translate("MainWindow", "Soma", 0));
    radioButtonSub->setText(QApplication::translate("MainWindow", "Subtra\303\247\303\243o", 0));
    radioButtonDiv->setText(QApplication::translate("MainWindow", "Divis\303\243o", 0));
    menuE_xit->setTitle(QApplication::translate("MainWindow", "E&xit", 0));
